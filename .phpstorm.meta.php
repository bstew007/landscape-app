...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cache.prefix' => 'string',
            'calculator_scopes.turf_mowing' => 'string',
            'calculator_scopes.syn_turf' => 'string',
            'calculator_scopes.mulching' => 'string',
            'calculator_scopes.paver_patio' => 'string',
            'calculator_scopes.retaining_wall' => 'string',
            'calculator_scopes.fence' => 'string',
            'calculator_scopes.pruning' => 'string',
            'calculator_scopes.weeding' => 'string',
            'calculator_scopes.pine_needles' => 'string',
            'calculator_scopes.turf_mowing_weekly' => 'string',
            'calculator_scopes.turf_mowing_biweekly' => 'string',
            ...
            'filesystems.links./Users/robertstewart/Documents/laravel/www/landscape-app/public/storage' => 'string',
            ...
            'qbo.client_id' => 'string',
            'qbo.client_secret' => 'string',
            'qbo.redirect_uri' => 'string',
            'qbo.environment' => 'string',
            'qbo.webhook_token' => 'NULL',
            'qbo.auto_sync' => 'boolean',
            'qbo.debug' => 'boolean',
            'qbo.scopes' => 'array',
            ...
            'services.google_places.country' => 'string',
            ...
            'syn_turf.materials.turf_tiers.good.label' => 'string',
            'syn_turf.materials.turf_tiers.good.unit_cost' => 'double',
            'syn_turf.materials.turf_tiers.better.label' => 'string',
            'syn_turf.materials.turf_tiers.better.unit_cost' => 'double',
            'syn_turf.materials.turf_tiers.best.label' => 'string',
            'syn_turf.materials.turf_tiers.best.unit_cost' => 'double',
            'syn_turf.materials.infill.coverage_sqft_per_bag' => 'integer',
            'syn_turf.materials.infill.unit_cost' => 'double',
            'syn_turf.materials.edging.board_length_ft' => 'integer',
            'syn_turf.materials.edging.unit_cost' => 'double',
            'syn_turf.materials.weed_barrier.coverage_sqft_per_roll' => 'integer',
            'syn_turf.materials.weed_barrier.unit_cost' => 'double',
            'syn_turf.materials.base.abc.unit_cost' => 'double',
            'syn_turf.materials.base.rock_dust.unit_cost' => 'double',
            'syn_turf.materials.rentals.tamper_daily_cost' => 'double',
...
'manage-catalogs','manage-users','view','update','delete',
'duplicate',);
...
'cache.prefix','calculator_scopes.turf_mowing','calculator_scopes.syn_turf','calculator_scopes.mulching','calculator_scopes.paver_patio',
'calculator_scopes.retaining_wall','calculator_scopes.fence','calculator_scopes.pruning','calculator_scopes.weeding','calculator_scopes.pine_needles',
'calculator_scopes.turf_mowing_weekly','calculator_scopes.turf_mowing_biweekly','database.default','database.connections.sqlite.driver','database.connections.sqlite.url',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/robertstewart/Documents/laravel/www/landscape-app/public/storage','logging.default','logging.deprecations.channel',
...
'qbo.client_id','qbo.client_secret','qbo.redirect_uri','qbo.environment','qbo.webhook_token',
'qbo.auto_sync','qbo.debug','qbo.scopes','queue.default','queue.connections.sync.driver',
...
'services.slack.notifications.channel','services.google_places.key','services.google_places.country','session.driver','session.lifetime',
...
'session.secure','session.http_only','session.same_site','session.partitioned','syn_turf.materials.turf_tiers.good.label',
'syn_turf.materials.turf_tiers.good.unit_cost','syn_turf.materials.turf_tiers.better.label','syn_turf.materials.turf_tiers.better.unit_cost','syn_turf.materials.turf_tiers.best.label','syn_turf.materials.turf_tiers.best.unit_cost',
'syn_turf.materials.infill.coverage_sqft_per_bag','syn_turf.materials.infill.unit_cost','syn_turf.materials.edging.board_length_ft','syn_turf.materials.edging.unit_cost','syn_turf.materials.weed_barrier.coverage_sqft_per_roll',
'syn_turf.materials.weed_barrier.unit_cost','syn_turf.materials.base.abc.unit_cost','syn_turf.materials.base.rock_dust.unit_cost','syn_turf.materials.rentals.tamper_daily_cost','dompdf.show_warnings',
...
'web','api',);
        registerArgumentsSet('routes', 'api.materials.active','api.materials.search','api.materials.show',
'dashboard','legal.eula','legal.privacy','legal.terms','integrations.qbo.webhook',
'calculators.index','calculators.import-to-estimate','client-hub','calendar.index','profile.edit',
'profile.update','profile.destroy','materials.importForm','materials.import','materials.export',
'materials.bulk.ping','materials.bulk','materials.bulk.alt.ping','materials.bulk.alt','materials.index',
'materials.create','materials.store','materials.edit','materials.update','materials.destroy',
'labor.importForm','labor.import','labor.export','labor.index','labor.create',
'labor.store','labor.edit','labor.update','labor.destroy','production-rates.bulkUpdate',
'production-rates.index','production-rates.create','production-rates.store','production-rates.edit','production-rates.update',
'production-rates.destroy','api.catalog.defaults','site-visits.storeCalculation','site-visit.select','calculators.selectSiteVisit',
'site-visits.deleteCalculation','calculators.fence.form','calculators.fence.calculate','calculators.fence.showResult','calculators.fence.edit',
'calculators.fence.downloadPdf','calculators.patio.form','calculators.patio.calculate','calculations.patio.showResult','calculators.patio.edit',
'calculations.patio.downloadPdf','calculators.wall.form','calculators.wall.calculate','calculations.wall.showResult','calculators.wall.edit',
'calculations.wall.downloadPdf','calculators.weeding.form','calculators.weeding.calculate','calculators.weeding.edit','calculators.weeding.showResult',
'calculators.weeding.downloadPdf','calculators.mulching.form','calculators.mulching.calculate','calculators.mulching.edit','calculators.mulching.showResult',
'calculators.mulching.downloadPdf','calculators.pine_needles.form','calculators.pine_needles.calculate','calculators.pine_needles.edit','calculators.pine_needles.showResult',
'calculators.pine_needles.downloadPdf','calculators.syn_turf.form','calculators.syn_turf.calculate','calculators.syn_turf.edit','calculators.syn_turf.showResult',
'calculators.syn_turf.email','calculators.syn_turf.downloadPdf','calculators.planting.form','calculators.planting.calculate','calculators.planting.edit',
'calculators.planting.showResult','calculators.planting.downloadPdf','calculators.turf_mowing.form','calculators.turf_mowing.calculate','calculators.turf_mowing.edit',
'calculators.turf_mowing.showResult','calculators.turf_mowing.downloadPdf','calculators.pruning.form','calculators.pruning.calculate','calculators.pruning.edit',
'calculators.pruning.showResult','calculators.pruning.downloadPdf','contacts.qbo.sync','contacts.qbo.refresh','contacts.qbo.push-names',
'contacts.qbo.push-mobile','contacts.qbo.vendor.sync','contacts.qbo.vendor.refresh','contacts.qbo.vendor.push-names','contacts.qbo.vendor.push-mobile',
'contacts.qbo.customer.link-page','contacts.qbo.customer.sync-all','contacts.qbo.search','contacts.qbo.import','contacts.qbo.import.selected',
'contacts.qbo.import.bulk','contacts.qbo.link','contacts.qbo.vendor.link-page','contacts.qbo.vendor.search','contacts.qbo.vendor.import',
'contacts.qbo.vendor.link','contacts.qbo.vendor.sync-all','contacts.index','contacts.create','contacts.store',
'contacts.show','contacts.edit','contacts.update','contacts.destroy','clients.index',
'clients.create','clients.show','clients.edit','clients.store','clients.update',
'clients.destroy','contacts.properties.index','contacts.properties.create','contacts.properties.store','contacts.properties.edit',
'contacts.properties.update','contacts.properties.destroy','contacts.site-visits.index','contacts.site-visits.create','contacts.site-visits.store',
'contacts.site-visits.show','contacts.site-visits.edit','contacts.site-visits.update','contacts.site-visits.destroy','contacts.site-visits.photos.store',
'contacts.site-visits.photos.destroy','clients.properties.index','clients.properties.create','clients.properties.store','clients.properties.edit',
'clients.properties.update','clients.properties.destroy','clients.site-visits.index','clients.site-visits.create','clients.site-visits.store',
'clients.site-visits.show','clients.site-visits.edit','clients.site-visits.update','clients.site-visits.destroy','clients.site-visits.photos.store',
'clients.site-visits.photos.destroy','site-visits.report','site-visits.report.pdf','todos.index','todos.create',
'todos.store','todos.edit','todos.update','todos.destroy','todos.updateStatus',
'site-visits.estimate-line-items','estimates.preview-email','estimates.print','estimates.recalculate','estimates.reports.cost-analysis',
'estimates.reports.labor-hours','estimates.reports.material-requirements','estimates.reports.profit-margin','estimates.bulk-update-status','estimates.index',
'estimates.create','estimates.store','estimates.show','estimates.edit','estimates.update',
'estimates.destroy','estimates.bulk-status','purchase-orders.index','purchase-orders.show','purchase-orders.destroy',
'purchase-orders.print','purchase-orders.print-batch','estimates.generate-purchase-orders','purchase-orders.update-status','purchase-orders.qbo.sync',
'purchase-orders.qbo.sync-batch','purchase-orders.qbo.delete','invoices.qbo.create','invoices.qbo.refresh','admin.budgets.index',
'admin.budgets.create','admin.budgets.store','admin.budgets.edit','admin.budgets.update','admin.users.index',
'admin.users.create','admin.users.store','admin.users.edit','admin.users.update','admin.users.destroy',
'admin.divisions.index','admin.divisions.create','admin.divisions.store','admin.divisions.edit','admin.divisions.update',
'admin.divisions.destroy','admin.cost-codes.index','admin.cost-codes.create','admin.cost-codes.store','admin.cost-codes.edit',
'admin.cost-codes.update','admin.cost-codes.destroy','admin.material-categories.index','admin.material-categories.create','admin.material-categories.store',
'admin.material-categories.edit','admin.material-categories.update','admin.material-categories.destroy','admin.qbo.items.search','admin.company-settings.edit',
'admin.company-settings.update','integrations.qbo.settings','integrations.qbo.launch','integrations.qbo.connect','integrations.qbo.callback',
'integrations.qbo.disconnect','estimates.items.store','estimates.items.update','estimates.items.destroy','estimates.items.reorder',
'estimates.areas.store','estimates.areas.update','estimates.areas.destroy','estimates.areas.reorder','estimates.areas.customPrice',
'estimates.areas.customProfit','estimates.areas.clearCustomPricing','estimates.remove-calculation','estimates.files.store','estimates.files.destroy',
'estimates.calculator.templates','estimates.calculator.import','calculator.templates.gallery','calculator.templates.estimates.search','calculator.templates.estimates.areas',
'calculator.templates.update','calculator.templates.destroy','calculator.templates.duplicate','calculator.templates.import','calculator.templates.save',
'estimates.email','estimates.invoice','assets.issues.create','assets.issues.quickStore','assets.reminders.create',
'assets.reminders.store','assets.index','assets.create','assets.store','assets.show',
'assets.edit','assets.update','assets.destroy','assets.maintenance.store','assets.issues.store',
'assets.attachments.store','assets.attachments.destroy','register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','storage.local',);
        registerArgumentsSet('views', 
'admin.budgets.edit','admin.budgets.index','admin.budgets.partials._analysis','admin.budgets.partials._equipment','admin.budgets.partials._field_labor',
'admin.budgets.partials._materials','admin.budgets.partials._oh_recovery','admin.budgets.partials._overhead','admin.budgets.partials._profit_loss','admin.budgets.partials._sales',
'admin.budgets.partials._subcontracting','admin.company-settings.edit','admin.cost-codes.create','admin.cost-codes.edit','admin.cost-codes.index',
'admin.divisions.create','admin.divisions.edit','admin.divisions.index','admin.material-categories.create','admin.material-categories.edit',
'admin.material-categories.index','admin.users.create','admin.users.edit','admin.users.index','assets._form',
'assets.create','assets.edit','assets.index','assets.quick-issue','assets.reminder',
'assets.show','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','auth.verify-email','calculators.fence.form','calculators.fence.partials.overrides','calculators.fence.pdf',
'calculators.fence.results','calculators.index','calculators.mulching.form','calculators.mulching.pdf','calculators.mulching.result',
'calculators.partials.actions','calculators.partials.client_info','calculators.partials.custom-material-row','calculators.partials.form_header','calculators.partials.material_override_inputs',
'calculators.partials.materials_table','calculators.partials.overhead_inputs','calculators.partials.section_heading','calculators.paver-patio.form','calculators.paver-patio.pdf',
'calculators.paver-patio.results','calculators.pine_needles.form','calculators.pine_needles.pdf','calculators.pine_needles.result','calculators.planting.form',
'calculators.planting.pdf','calculators.planting.result','calculators.pruning.form','calculators.pruning.pdf','calculators.pruning.result',
'calculators.reports.fence','calculators.reports.mulching','calculators.reports.paver_patio','calculators.reports.pdf.fence','calculators.reports.pdf.mulching',
'calculators.reports.pdf.paver_patio','calculators.reports.pdf.pine_needles','calculators.reports.pdf.planting','calculators.reports.pdf.pruning','calculators.reports.pdf.retaining_wall',
'calculators.reports.pdf.syn_turf','calculators.reports.pdf.turf_mowing','calculators.reports.pdf.weeding','calculators.reports.pine_needles','calculators.reports.planting',
'calculators.reports.pruning','calculators.reports.retaining_wall','calculators.reports.syn_turf','calculators.reports.turf_mowing','calculators.reports.weeding',
'calculators.retaining-wall.form','calculators.retaining-wall.form-old-backup','calculators.retaining-wall.pdf','calculators.retaining-wall.results','calculators.retaining-wall.results-old-backup',
'calculators.select-site-visit','calculators.syn-turf.form','calculators.syn-turf.pdf','calculators.syn-turf.result','calculators.templates.index',
'calculators.turf-mowing.form','calculators.turf-mowing.pdf','calculators.turf-mowing.result','calculators.weeding.form','calculators.weeding.pdf',
'calculators.weeding.result','calendar.index','client-hub.index','clients._form','clients.create',
'clients.edit','clients.index','clients.show','clients.tabs.comms','clients.tabs.estimates',
'clients.tabs.info','clients.tabs.invoices','clients.tabs.properties','components.application-logo','components.auth-session-status',
'components.brand-button','components.close-button','components.compact-input-row','components.danger-button','components.dropdown',
'components.dropdown-link','components.input','components.input-error','components.input-label','components.material-catalog-picker',
'components.modal','components.nav-link','components.page-header','components.panel-card','components.primary-button',
'components.ratio-pill','components.responsive-nav-link','components.secondary-button','components.text-input','contacts.customer-qbo-link',
'contacts.index','contacts.qbo-import','contacts.qbo-vendor-import','contacts.vendor-qbo-link','dashboard',
'emails.estimates.sent','emails.syn-turf-estimate','estimates._form','estimates._form_simple','estimates.create',
'estimates.edit','estimates.index','estimates.partials.add-items-panel','estimates.partials.add-items-panel-old','estimates.partials.analysis',
'estimates.partials.area','estimates.partials.client-info','estimates.partials.crew-notes','estimates.partials.header','estimates.partials.invoice',
'estimates.partials.item-row','estimates.partials.modals._custom-pricing','estimates.partials.notes','estimates.partials.overview','estimates.partials.print-documents',
'estimates.partials.project-info','estimates.partials.summary-cards','estimates.partials.work-area-modal','estimates.partials.work-areas','estimates.preview-email',
'estimates.print','estimates.print-templates._header','estimates.print-templates._styles','estimates.print-templates.full-detail','estimates.print-templates.labor-only',
'estimates.print-templates.materials-only','estimates.print-templates.proposal','estimates.print-templates.summary','estimates.reports.cost-analysis','estimates.reports.labor-hours',
'estimates.reports.material-requirements','estimates.reports.profit-margin','estimates.show','integrations.qbo','labor._form',
'labor.create','labor.edit','labor.import','labor.index','layouts.app',
'layouts.base','layouts.calculator','layouts.guest','layouts.navigation','layouts.sidebar',
'legal.eula','legal.privacy','legal.terms','mail::html.button','mail::html.footer',
'mail::html.header','mail::html.layout','mail::html.message','mail::html.panel','mail::html.subcopy',
'mail::html.table','mail::text.button','mail::text.footer','mail::text.header','mail::text.layout',
'mail::text.message','mail::text.panel','mail::text.subcopy','mail::text.table','materials._form',
'materials.create','materials.edit','materials.import','materials.index','production-rates.index',
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','properties._form',
'properties.create','properties.edit','purchase-orders.print','purchase-orders.print-batch','site-visits._form',
'site-visits.create','site-visits.edit','site-visits.index','site-visits.report','site-visits.report-pdf',
'site-visits.select','site-visits.show','todos._form','todos.create','todos.edit',
'todos.index','vendor.mail.html.button','vendor.mail.html.footer','vendor.mail.html.header','vendor.mail.html.layout',
...
'vendor.mail.text.subcopy','vendor.mail.text.table','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'laravel-exceptions::503','laravel-exceptions::layout','laravel-exceptions::minimal','mail::html.button','mail::html.footer',
'mail::html.header','mail::html.layout','mail::html.message','mail::html.panel','mail::html.subcopy',
'mail::html.table','mail::text.button','mail::text.footer','mail::text.header','mail::text.layout',
'mail::text.message','mail::text.panel','mail::text.subcopy','mail::text.table','notifications::email',
...
'DB_FOREIGN_KEYS','BROADCAST_DRIVER','CACHE_DRIVER','FILESYSTEM_DISK','QUEUE_CONNECTION',
...
'PUSHER_APP_CLUSTER','VITE_APP_NAME','QBO_CLIENT_ID','QBO_CLIENT_SECRET','QBO_ENV',
'QBO_REDIRECT_URI',);
