    ...
    <ul>
        ...
        <nav class="mt-4 px-4 space-y-6 text-sm">
            <div>
                ...
                <a href="{{ route('clients.index') }}" class="block px-2 py-1 mt-1 rounded text-gray-200 hover:bg-gray-800"><span class="inline-flex items-center"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4 mr-2"><circle cx="9" cy="8" r="3"/><circle cx="17" cy="10" r="3"/><path d="M2 21c0-3.314 2.686-6 6-6h2M22 21c0-3.314-2.686-6-6-6h-2"/></svg><span>Clients</span></span></a>
