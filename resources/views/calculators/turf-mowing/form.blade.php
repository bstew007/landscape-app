...
@section('content')
<div class="max-w-4xl mx-auto py-8 px-4" x-data="turfMowingCalculator()">
    {{-- Header --}}
    <div class="mb-8">
        <div class="flex items-center gap-3 mb-3">
            ...
            <div>
                <h1 class="text-4xl font-bold text-gray-900">
                    {{ $editMode ? 'Edit Turf Maintenance' : 'Turf Mowing Calculator' }}
                </h1>
                <p class="text-gray-600 mt-1">Calculate labor hours for mowing, trimming, edging, and blowing tasks</p>
            </div>
        </div>
    </div>
        ...
        <div class="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-lg shadow-sm mb-6">
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <p class="text-sm text-blue-800">Build a Turf Mowing template without a site visit.</p>
                    @if(!empty($estimateId))
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden mb-6">
            ...
            <div class="p-6">
                <textarea name="job_notes" 
                          ...
                          placeholder="Add any additional notes about this turf maintenance job...">{{ old('job_notes', $formData['job_notes'] ?? '') }}</textarea>
                <p class="mt-2 text-sm text-gray-500">Optional: Special instructions, site conditions, or other relevant details</p>
            </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            @if(($mode ?? null) === 'template')
                <div class="flex flex-col sm:flex-row gap-3 w-full">
                    <input type="text" 
                           ...
                           placeholder="Template name (e.g., Weekly mow package)" 
            ...
            @else
                <button type="submit" 
                    ...
                    {{ $editMode ? 'Recalculate' : 'Calculate Turf Maintenance' }}
                </button>
...
<script>
function turfMowingCalculator() {
    return {
        // Add any reactive functionality here if needed
    };
}
</script>
@endsection
