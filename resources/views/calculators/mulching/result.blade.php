...
<div class="max-w-5xl mx-auto py-10">
    <h1 class="text-3xl font-bold mb-6">✂️ Mulching Data Summary</h1>
...
@endif
    ...
    {{-- Actions --}}
    @php $downloadUrl = isset($calculation) ? route('calculators.mulching.downloadPdf', $calculation->id) : null; @endphp
    @include('calculators.partials.actions', [
        'calculationType' => 'mulching',
        'siteVisit' => $siteVisit,
        'data' => $data,
