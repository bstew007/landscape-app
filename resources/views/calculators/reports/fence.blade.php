...
<section class="bg-white p-6 rounded shadow space-y-4">
    <div class="flex items-center justify-between">
        <h2 class="text-2xl font-semibold">🪵 Fence Estimate</h2>
    ...
    <div class="grid md:grid-cols-2 gap-4">
        <div class="bg-gray-50 p-4 rounded">
            ...
            <p>Base Labor: {{ number_format($data['base_hours'] ?? $data['labor_hours'], 2) }} hrs</p>
            <p>Total Labor: {{ number_format($data['total_hours'], 2) }} hrs</p>
