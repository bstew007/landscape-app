                    ...
                    <div class="grid md:grid-cols-3 gap-4">
                        ...
                        <x-panel-card title="Activation">
                            ...
                            <div x-data="{ active: {{ old('inputs.oh_recovery.labor_hour.activated', data_get($budget->inputs ?? [], 'oh_recovery.labor_hour.activated', false)) ? 'true' : 'false' }} }" class="space-y-1.5">
                                ...
                                <!-- Save the calculated markup per hour -->
                                <input type="hidden" name="inputs[oh_recovery][labor_hour][markup_per_hour]" :value="(function(){ const hrs = totalHours(); return hrs ? (overheadCurrentTotal()/hrs).toFixed(2) : 0; })()">
                            </div>
                        </x-panel-card>
                    </div>
                </section>
